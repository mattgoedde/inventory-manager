    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemEntity_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemEntityTagEntity", x => new { x.ItemsId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_ItemEntityTagEntity_ItemEntity_ItemsId",
                        column: x => x.ItemsId,
                        principalTable: "ItemEntity",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemEntityTagEntity_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemEntity_LocationId",
                table: "ItemEntity",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemEntity_TenantId",
                table: "ItemEntity",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemEntityTagEntity_TagsId",
                table: "ItemEntityTagEntity",
                column: "TagsId");
